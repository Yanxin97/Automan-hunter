...
size_t HunterStatus__rosidl_typesupport_introspection_c__size_function__HunterActuatorState__actuator_states(
...
const void * HunterStatus__rosidl_typesupport_introspection_c__get_const_function__HunterActuatorState__actuator_states(
...
void * HunterStatus__rosidl_typesupport_introspection_c__get_function__HunterActuatorState__actuator_states(
...
static rosidl_typesupport_introspection_c__MessageMember HunterStatus__rosidl_typesupport_introspection_c__HunterStatus_message_member_array[8] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hunter_msgs__msg__HunterStatus, angular_velocity),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    NULL,  // default value
    HunterStatus__rosidl_typesupport_introspection_c__size_function__HunterActuatorState__actuator_states,  // size() function pointer
    HunterStatus__rosidl_typesupport_introspection_c__get_const_function__HunterActuatorState__actuator_states,  // get_const(index) function pointer
    HunterStatus__rosidl_typesupport_introspection_c__get_function__HunterActuatorState__actuator_states,  // get(index) function pointer
    NULL  // resize(index) function pointer
  }
};
